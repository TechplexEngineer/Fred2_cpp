...
#include "Commands/a_drive_turn_enc.h"
#include "Commands/a_drive_turn_lisa.h"
...
#include "Commands/auto_3tote_piston.h"
...
#include "Commands/sd_turn_enc.h"
...
OI::OI() {
	...
	SmartDashboard::PutData("sd_turn_enc", new sd_turn_enc());

	SmartDashboard::PutData("a_drive_turn_lisa", new a_drive_turn_lisa());
